...
namespace Company.Function
{
    public static class GetResumeCounter
    {
        ...
        public static HttpResponseMessage Run(
            ...
            [CosmosDB(databaseName:"AzureResume", collectionName: "Counter", ConnectionStringSetting = "Azure_Cloud_Challenge_String", Id = "1", PartitionKey = "1")] out Counter updatedCounter,
            ILogger log)
        {
